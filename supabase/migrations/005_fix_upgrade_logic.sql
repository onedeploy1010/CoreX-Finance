-- Fix check_and_upgrade_level:
-- 1. "有效账户" = staking >= 200 USDT (not just any active order)
-- 2. V0->V1: needs 2 direct referrals who are "有效" (staking >= 200)
-- 3. V2+: count total team members at required level (same org line counts)
-- 4. Team staking = all team staking, no big/small区 distinction

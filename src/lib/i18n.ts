...
const translations: Record<string, Partial<Record<Lang, string>>> = {
  ...
  "orders.auto_reinvest_countdown": {
    ...
    ko: "자동 재투자 카운트다운", vi: "Đếm ngược tái đầu tư",
    th: "นับถอยหลังลงทุนใหม่อัตโนมัติ", id: "Hitung mundur investasi ulang otomatis",
    ms: "Kira detik labur semula automatik", fr: "Compte à rebours réinvestissement",
    ar: "العد التنازلي لإعادة الاستثمار التلقائي",
  },
  ...
  "home.pay_onchain": { zh: "链上支付", "zh-TW": "鏈上支付", en: "On-chain Payment", ja: "オンチェーン決済", ko: "온체인 결제", vi: "Thanh toán on-chain", th: "ชำระเงินออนเชน", id: "Pembayaran On-chain", ms: "Pembayaran On-chain", fr: "Paiement on-chain", ar: "الدفع على السلسلة" },
  "home.pay_balance": { zh: "余额支付", "zh-TW": "餘額支付", en: "Balance Payment", ja: "残高払い", ko: "잔액 결제", vi: "Thanh toán số dư", th: "ชำระจากยอดเงิน", id: "Pembayaran Saldo", ms: "Pembayaran Baki", fr: "Paiement par solde", ar: "الدفع من الرصيد" },
  "home.available_balance": { zh: "可用余额", "zh-TW": "可用餘額", en: "Available Balance", ja: "利用可能残高", ko: "사용 가능 잔액", vi: "Số dư khả dụng", th: "ยอดเงินที่ใช้ได้", id: "Saldo Tersedia", ms: "Baki Tersedia", fr: "Solde disponible", ar: "الرصيد المتاح" },
  "home.insufficient_balance": { zh: "余额不足", "zh-TW": "餘額不足", en: "Insufficient balance", ja: "残高不足", ko: "잔액 부족", vi: "Số dư không đủ", th: "ยอดเงินไม่เพียงพอ", id: "Saldo tidak cukup", ms: "Baki tidak mencukupi", fr: "Solde insuffisant", ar: "رصيد غير كافٍ" },
  "home.balance_payment_note": { zh: "使用可提现余额支付，无需链上转账", "zh-TW": "使用可提現餘額支付，無需鏈上轉帳", en: "Pay with available balance, no on-chain transfer needed", ja: "利用可能残高で支払い、オンチェーン送金不要", ko: "사용 가능 잔액으로 결제, 온체인 전송 불필요", vi: "Thanh toán bằng số dư, không cần chuyển on-chain", th: "ชำระจากยอดเงิน ไม่ต้องโอนออนเชน", id: "Bayar dengan saldo, tanpa transfer on-chain", ms: "Bayar dengan baki, tanpa pemindahan on-chain", fr: "Payez avec votre solde, pas de transfert on-chain", ar: "ادفع من الرصيد، لا حاجة للتحويل على السلسلة" },
  ...
  "product.name_6": { zh: "芯未来5号", "zh-TW": "芯未來5號", en: "CoreX Future V", ko: "CoreX Future V", ja: "CoreX Future V", vi: "CoreX Future V", th: "CoreX Future V", id: "CoreX Future V", ms: "CoreX Future V", fr: "CoreX Future V", ar: "CoreX Future V" },
  ...
  "product.desc_6": { zh: "顶级长周期收益", "zh-TW": "頂級長週期收益", en: "Premium long-term yield", ko: "프리미엄 장기 수익", ja: "プレミアム長期利回り", vi: "Lợi nhuận dài hạn cao cấp", th: "ผลตอบแทนระยะยาวระดับพรีเมียม", id: "Hasil jangka panjang premium", ms: "Pulangan jangka panjang premium", fr: "Rendement long terme premium", ar: "عائد طويل الأجل ممتاز" },

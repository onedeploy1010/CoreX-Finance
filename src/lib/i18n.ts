...
const translations: Record<string, Partial<Record<Lang, string>>> = {
  ...
  "orders.redeem_now": {
    zh: "立即赎回本金", "zh-TW": "立即贖回本金", en: "Redeem Principal Now", ja: "元本を今すぐ償還",
    ko: "지금 원금 상환", vi: "Rút vốn ngay", th: "ไถ่ถอนเงินต้นทันที",
    id: "Tebus Modal Sekarang", ms: "Tebus Modal Sekarang",
    fr: "Racheter le capital", ar: "استرد رأس المال الآن",
  },

...
const translations: Record<string, Partial<Record<Lang, string>>> = {
  ...
  "invite.team_formula_desc": { zh: "伞下团队业绩 × 自身投资最高配套的日化收益 × 各等级分成比例", "zh-TW": "傘下團隊業績 × 自身投資最高配套的日化收益 × 各等級分成比例", en: "Team Performance × Daily Rate of Highest Investment × Level Commission %", ko: "팀 실적 × 최고 투자 일일 수익률 × 등급 수수료%", ja: "チーム実績 × 最高投資の日利率 × レベル手数料%", vi: "Hiệu suất đội × Lãi suất ngày của khoản đầu tư cao nhất × Tỷ lệ hoa hồng cấp%", th: "ผลงานทีม × อัตราผลตอบแทนรายวันของการลงทุนสูงสุด × อัตราค่าคอมมิชชั่นระดับ%", id: "Kinerja Tim × Tarif Harian Investasi Tertinggi × Komisi Level%", ms: "Prestasi Pasukan × Kadar Harian Pelaburan Tertinggi × Komisen Tahap%", fr: "Performance équipe × Taux quotidien de l'investissement le plus élevé × Commission niveau%", ar: "أداء الفريق × معدل العائد اليومي لأعلى استثمار × نسبة عمولة المستوى%" },
